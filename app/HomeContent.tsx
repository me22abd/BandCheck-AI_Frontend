...
const TESTIMONIALS = [
  ...
  {
    quote:
      "Honestly surprised how easy it was. Submitted the letter, VOA confirmed the change within 6 weeks. Highly recommend.",
    name: "James H.",
    area: "Leeds",
    saving: "£380/yr",
  },
  {
    quote:
      "We've been in Band E for 12 years. Turns out 6 houses on our street are Band D. The refund more than covered our holiday.",
    name: "Priya M.",
    area: "Birmingham",
    saving: "£3,200 refund",
  },
    ...
    <div className="mb-6 flex items-start gap-3 rounded-xl border border-forest/20 bg-forest/8 px-4 py-3.5">
      ...
      <div>
        ...
        <p className="mt-0.5 text-xs leading-relaxed text-ink-3">
          They checked their council tax band with BandCheck AI. Enter your
          postcode below to see if you&apos;re overpaying too.
        </p>
      </div>
    </div>
  );
        ...
        <EditorialCard className="overflow-hidden p-0">
          <div className="bg-ink px-6 py-7">
            ...
            <p className="mt-2 text-sm leading-relaxed text-paper/60">
              The BandCheck AI app lets you check postcodes, manage your appeal
              progress, and receive reminders — all from your phone.
            </p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <EditorialCard className="p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink-2">
            Real property data, plain English, no solicitors and no upfront
            cost.
          </p>
          <Link
            href="/about"
        ...
        <EditorialCard className="p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink-2">
            Free to check. We take a small share of savings — only if your
            appeal succeeds.
          </p>
          <Link
            href="/pricing"
