  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 text-gray-900">
        ...
        {/* What we do */}
        <div className="mt-16 rounded-xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3">
            {features.map((f) => (
              <div
                key={f}
                className="flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-700"
              >
                <span className="flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-blue-100 text-xs font-bold text-blue-600">
                  ✓
                </span>
                {f}
              </div>
        ...
        <div className="mt-16 rounded-xl border border-blue-100 bg-blue-50 p-8 text-center">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/how-it-works"
              className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-150 hover:bg-gray-50"
            >
              How it works
            </Link>
          </div>
