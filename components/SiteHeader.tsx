  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {[
          { icon: "🔍", title: "Instant analysis", body: "Enter your postcode and see results in seconds, powered by real property data." },
          { icon: "📊", title: "Clear comparisons", body: "Side-by-side band comparison with nearby similar properties — easy to understand." },
          { icon: "📋", title: "Appeal pack", body: "We generate a structured appeal document ready for the Valuation Office Agency." },
          { icon: "🔒", title: "Privacy first", body: "Your email and property details are never sold or shared with third parties." },
          { icon: "💷", title: "No win, no fee", body: "You never pay upfront. We only earn when your appeal succeeds." },
          { icon: "🏘️", title: "Real data", body: "Comparable property data is sourced from publicly available council tax records." },
        ].map(({ icon, title, body }) => (
